...
async function main() {
    ...
    const USDCAmountOut = ethers.parseUnits("20000", 6);
    const DAIAmountOut = ethers.parseUnits("2000000000000000000000", 18);
    ...
    //TO GET THE BALANCE OF OTHER TOKENS
    ...
    const swapTx =
        await ROUTER.connect(impersonatedSigner).swapExactTokensForTokensSupportingFeeOnTransferTokens(
            USDCAmountOut,
            0,
